...
env="aps"
algo="gnnmappol"
exp="los_hexaps_mrt/ap20_ue6_se1_8env/ped_1step_50ms/gnnmappolf1r3-samelagr2-lambdamax1000-ppoepoch5-ppoclip0.15" # 4strongest
seed=1
python train_gnnmappol.py --use_valuenorm --env_name ${env} --algorithm_name ${algo} \
 ...
 --gamma 0.01 --use_linear_lr_decay --log_interval 1 --clip_param 0.15 \
 --entropy_coef 0.1  --if_update_lagr_per_ue False --if_pid_lagr_update False --if_rnn_gnn True \
 --lagrangian_coef_rate 2.0 --lambda_lagr_max 1000.0 --lagr_pid_kp 3 --lagr_pid_ki 3 --lagr_pid_kd 3 \
#  --model_dir pretrained_models/los_hexaps_ap20_ue6_ped_3history_f1/4strongest 
