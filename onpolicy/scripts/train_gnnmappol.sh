...
env="aps"
algo="gnnmappol"
exp="mrt_allsinr_los_se_hexaps/ap20_ue6_se1_16env/ped2_1step_50ms/gnnmappol_adptv_p05i01d1"
seed=1
python train_gnnmappol.py --use_valuenorm --env_name ${env} --algorithm_name ${algo} \
 ...
 --num_mini_batch 1 --episode_length 32 --num_env_steps 3000000 \
 ...
 --entropy_coef 0.1  --if_pid_lagr_update True 
