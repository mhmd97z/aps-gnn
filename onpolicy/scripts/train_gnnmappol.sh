...
env="aps"
algo="gnnmappol"
exp="los_hexaps_mrt/ap20_ue6_se1_8env/ped_1step_50ms/gnnmappolf1r3-4strongest-samelagr1-lambdamax10000-ppoepoch10-ppoclip0.1"
seed=1
python train_gnnmappol.py --use_valuenorm --env_name ${env} --algorithm_name ${algo} \
 ...
 --lagrangian_coef_rate 1.0 --lambda_lagr_max 10000.0 --lagr_pid_kp 3 --lagr_pid_ki 3 --lagr_pid_kd 3 \
 --model_dir /home/mzi/aps-gnn/onpolicy/results/aps/gnnmappo/pretraining/los_hexap20_ue6_ped_history3_f1/4strongest/run1/models/
